parcelRequire = function (e, r, t, n) {
  ...
  "La2s": [function (require, module, exports) {
    ...
    const D = (() => "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : t)(),
      T = e => !u(e) && e !== D;
    function E() {
      const {
          caseless: e
        ...
        r = (r, n) => {
          const o = e && C(t, n) || n;
          m(t[o]) && m(r) ? t[o] = E(t[o], r) : m(r) ? t[o] = E({}, r) : c(r) ? t[o] = r.slice() : t[o] = r;
        };
    ...
    const v = (e, t, n, {
      ...
      I = (e => t => e && t instanceof e)("undefined" != typeof Uint8Array && i(Uint8Array)),
      k = (e, t) => {
      ...
      R = l("HTMLFormElement"),
      z = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function (e, t, r) {
  ...
  "mfZl": [function (require, module, exports) {
    ...
    function s(i, s, d) {
      ...
      const c = (d = t.default.toFlatObject(d, {
          metaTokens: !0,
          dots: !1,
          indexes: !1
        }, !1, function (e, r) {
  ...
  "w9Qq": [function (require, module, exports) {
    ...
    const e = exports.hasBrowserEnv = "undefined" != typeof window && "undefined" != typeof document,
      r = exports.hasStandardBrowserEnv = (r => e && ["ReactNative", "NativeScript", "NS"].indexOf(r) < 0)("undefined" != typeof navigator && navigator.product),
      o = exports.hasStandardBrowserWebWorkerEnv = (() => "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && "function" == typeof self.importScripts)();
  }, {}],
  ...
  "Jtvp": [function (require, module, exports) {
    ...
    const u = {
      ...
      transformRequest: [function (t, r) {
        ...
        if (u && e.default.isHTMLForm(t) && (t = new FormData(t)), e.default.isFormData(t)) return o ? JSON.stringify((0, s.default)(t)) : t;
  ...
  "SsJs": [function (require, module, exports) {
    ...
    class f {
      ...
      set(r, n, o) {
        ...
        return t.default.isPlainObject(r) || r instanceof this.constructor ? l(r, n) : t.default.isString(r) && (r = r.trim()) && !c(r) ? l((0, e.default)(r), n) : null != r && u(n, r, o), this;
      }
      get(e, r) {
        if (e = s(e)) {
    ...
    f.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent", "Authorization"]), t.default.reduceDescriptors(f.prototype, ({
      value: t
    }, e) => {
  ...
  "DiA2": [function (require, module, exports) {
    ...
    var h = exports.default = E && function (c) {
      return new Promise(function (p, E) {
        ...
        function b() {
          c.cancelToken && c.cancelToken.unsubscribe(g), c.signal && c.signal.removeEventListener("abort", g);
        }
        if (e.default.isFormData(h)) if (d.default.hasStandardBrowserEnv || d.default.hasStandardBrowserWebWorkerEnv) T.setContentType(!1);else if (!1 !== (R = T.getContentType())) {
          const [e, ...t] = R ? R.split(";").map(e => e.trim()).filter(Boolean) : [];
          T.setContentType([e || "multipart/form-data", ...t].join("; "));
        }
        ...
        function j() {
          if (!v) return;
          const e = f.default.from("getAllResponseHeaders" in v && v.getAllResponseHeaders()),
            o = {
              data: w && "text" !== w && "json" !== w ? v.response : v.responseText,
              status: v.status,
        ...
        if (v.open(c.method.toUpperCase(), (0, r.default)(x, c.params, c.paramsSerializer), !0), v.timeout = c.timeout, "onloadend" in v ? v.onloadend = j : v.onreadystatechange = function () {
          v && 4 === v.readyState && (0 !== v.status || v.responseURL && 0 === v.responseURL.indexOf("file:")) && setTimeout(j);
        }, v.onabort = function () {
          v && (E(new u.default("Request aborted", u.default.ECONNABORTED, c, v)), v = null);
        }, v.onerror = function () {
          E(new u.default("Network Error", u.default.ERR_NETWORK, c, v)), v = null;
        }, v.ontimeout = function () {
          let e = c.timeout ? "timeout of " + c.timeout + "ms exceeded" : "timeout exceeded";
          const t = c.transitional || a.default;
          c.timeoutErrorMessage && (e = c.timeoutErrorMessage), E(new u.default(e, t.clarifyTimeoutError ? u.default.ETIMEDOUT : u.default.ECONNABORTED, c, v)), v = null;
        }, d.default.hasStandardBrowserEnv && (q && e.default.isFunction(q) && (q = q(c)), q || !1 !== q && (0, s.default)(x))) {
          const e = c.xsrfHeaderName && c.xsrfCookieName && o.default.read(c.xsrfCookieName);
          e && T.set(c.xsrfHeaderName, e);
        }
        void 0 === h && T.setContentType(null), "setRequestHeader" in v && e.default.forEach(T.toJSON(), function (e, t) {
          v.setRequestHeader(t, e);
        }), e.default.isUndefined(c.withCredentials) || (v.withCredentials = !!c.withCredentials), w && "json" !== w && (v.responseType = c.responseType), "function" == typeof c.onDownloadProgress && v.addEventListener("progress", m(c.onDownloadProgress, !0)), "function" == typeof c.onUploadProgress && v.upload && v.upload.addEventListener("progress", m(c.onUploadProgress)), (c.cancelToken || c.signal) && (g = e => {
          v && (E(!e || e.type ? new l.default(null, c, v) : e), v.abort(), v = null);
        ...
        y && -1 === d.default.protocols.indexOf(y) ? E(new u.default("Unsupported protocol " + y + ":", u.default.ERR_BAD_REQUEST, c)) : v.send(h || null);
      });
    };
  }, {
    "./../utils.js": "La2s",
    "./../core/settle.js": "H2iV",
    "./../helpers/cookies.js": "k3ra",
    "./../helpers/buildURL.js": "x8Ee",
    "../core/buildFullPath.js": "PPse",
    "./../helpers/isURLSameOrigin.js": "qw5y",
  ...
  "Hy7a": [function (require, module, exports) {
    ...
    var u = exports.default = {
      getAdapter: t => {
        ...
        for (let e = 0; e < r; e++) {
          let r;
          if (u = n = t[e], !s(n) && void 0 === (u = i[(r = String(n)).toLowerCase()])) throw new a.default(`Unknown adapter '${r}'`);
          if (u) break;
          d[r || "#" + e] = u;
        }
        if (!u) {
          const e = Object.entries(d).map(([e, t]) => `adapter ${e} ` + (!1 === t ? "is not supported by the environment" : "is not available in the build"));
          let t = r ? e.length > 1 ? "since :\n" + e.map(o).join("\n") : " " + o(e[0]) : "as no adapter specified";
          throw new a.default("There is no suitable adapter to dispatch the request " + t, "ERR_NOT_SUPPORT");
        }
        return u;
      },
      adapters: i
  ...
  "koPw": [function (require, module, exports) {
    ...
    class c {
      ...
      _request(t, r) {
        ...
        c && e.default.forEach(["delete", "get", "head", "post", "put", "patch", "common"], e => {
          delete c[e];
        ...
        if (!h) {
          ...
          for (e.unshift.apply(e, f), e.push.apply(e, p), q = e.length, m = Promise.resolve(r); g < q;) m = m.then(e[g++], e[g++]);
          return m;
        }
        q = f.length;
        let y = r;
  ...
  "U60K": [function (require, module, exports) {
    ...
    }, m.spread = c.default, m.isAxiosError = p.default, m.mergeConfig = a.default, m.AxiosHeaders = j.default, m.formToJSON = r => (0, s.default)(e.default.isHTMLForm(r) ? new FormData(r) : r), m.getAdapter = q.default.getAdapter, m.HttpStatusCode = x.default, m.default = m;
  ...
  "odIX": [function (require, module, exports) {
    ...
    var e = exports.hideAlert = function () {
      ...
      t = exports.showAlert = function (t, r) {
        ...
        document.querySelector("body").insertAdjacentHTML("afterbegin", o), window.setTimeout(function () {}, 5e3);
      };
  }, {}],
  "mnjM": [function (require, module, exports) {
    ...
    function o() {
      ...
      }, j(O), f(O, l, "Generator"), f(O, c, function () {
        return this;
    ...
    var u = exports.login = function () {
        var e = a(o().mark(function e(n, i) {
          return o().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                return e.prev = 0, e.next = 3, t.default.post("/api/v1/users/login", {
                  email: n,
                  password: i
                });
              case 3:
                ...
                break;
              case 7:
                e.prev = 7, e.t0 = e.catch(0), (0, r.showAlert)("error", e.t0.response.data.message);
              case 10:
              case "end":
                return e.stop();
            }
      ...
      c = exports.signup = function () {
        var e = a(o().mark(function e(n, i, a, u) {
          return o().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                return e.prev = 0, e.next = 3, t.default.post("/api/v1/users/signup", {
                  name: n,
                  email: i,
                  password: a,
                  passwordConfirm: u
              ...
              case 3:
                "success" === e.sent.data.status && ((0, r.showAlert)("success", "Sign-up successful!"), window.setTimeout(function () {
      ...
      s = exports.logout = function () {
        var e = a(o().mark(function e() {
          return o().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                return e.prev = 0, e.next = 3, t.default.get("/api/v1/users/logout");
              case 3:
                "success" === e.sent.data.status && location.reload(!0), e.next = 11;
                break;
              case 7:
                e.prev = 7, e.t0 = e.catch(0), console.log(e.t0.response), (0, r.showAlert)("error", "Error logging out! Try again." + e.t0.response);
              case 11:
              case "end":
                return e.stop();
            }
  ...
  "FxPS": [function (require, module, exports) {
    ...
    function o() {
      ...
      return b.prototype = x, a(O, "constructor", {
        ...
        value: b,
        configurable: !0
      }), b.displayName = l(x, f, "GeneratorFunction"), r.isGeneratorFunction = function (t) {
        var r = "function" == typeof t && t.constructor;
        return !!r && (r === b || "GeneratorFunction" === (r.displayName || r.name));
      }, r.mark = function (t) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(t, x) : (t.__proto__ = x, l(t, f, "GeneratorFunction")), t.prototype = Object.create(O), t;
      }, r.awrap = function (t) {
        return {
          __await: t
        };
      }, j(S.prototype), l(S.prototype, s, function () {
        return this;
      ...
      }, j(O), l(O, f, "Generator"), l(O, u, function () {
        return this;
    ...
    var c = exports.updateSettings = function () {
      var e = a(o().mark(function e(n, i) {
        ...
        return o().wrap(function (e) {
          for (;;) switch (e.prev = e.next) {
            case 0:
              return e.prev = 0, a = "password" === i ? "/api/v1/users/updateMyPassword" : "/api/v1/users/updateMe", e.next = 4, t.default.patch(a, n);
            case 4:
              "success" === e.sent.data.status && ((0, r.showAlert)("success", "".concat(i.toUpperCase(), " updated successfully!")), location.reload(!0)), e.next = 11;
              break;
            case 8:
              e.prev = 8, e.t0 = e.catch(0), (0, r.showAlert)("error", e.t0.response.data.message);
            case 11:
            case "end":
              return e.stop();
          }
  ...
  "Uj2q": [function (require, module, exports) {
    ...
    function o() {
      ...
      }, k(j.prototype), l(j.prototype, s, function () {
        return this;
      ...
      }, k(O), l(O, f, "Generator"), l(O, u, function () {
        return this;
      }), l(O, "toString", function () {
        return "[object Generator]";
      }), r.keys = function (t) {
    ...
    var c = Stripe("pk_test_51Ovd3zKtuNRIpwxYCGSANYvLULGAxPZAGW2y5um9EezQFXb7NaZQOV008heJ0BNFIdlu13zwBpCRxlS9F58cPCKd00BP6kIGuO"),
      u = exports.bookTour = function () {
        var e = a(o().mark(function e(n) {
          ...
          return o().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                return e.prev = 0, e.next = 3, t.default.get("/api/v1/bookings/checkout-session/".concat(n));
              case 3:
                return i = e.sent, e.next = 6, c.redirectToCheckout({
              ...
              case 6:
                ...
                break;
              case 8:
                e.prev = 8, e.t0 = e.catch(0), console.log(e.t0), (0, r.showAlert)("error", e.t0);
              case 12:
              case "end":
                return e.stop();
            }
  ...
  "Focm": [function (require, module, exports) {
    ...
    function o() {
      ...
      function S(e, r) {
        function t(o, u, i, c) {
          ...
          if ("throw" !== a.type) {
            var l = a.arg,
              d = l.value;
            return d && "object" == s(d) && n.call(d, "__await") ? r.resolve(d.__await).then(function (e) {
              t("next", e, i, c);
            }, function (e) {
              t("throw", e, i, c);
      ...
      function I(r, t, s) {
        ...
        return function (n, u) {
          ...
          for (s.method = n, s.arg = u;;) {
            ...
            "throw" === a.type && (o = y, s.method = "throw", s.arg = a.arg);
          }
        };
      }
      function _(r, t) {
        var s = t.method,
          o = r.iterator[s];
        if (o === e) return t.delegate = null, "throw" === s && r.iterator.return && (t.method = "return", t.arg = e, _(r, t), "throw" === t.method) || "return" !== s && (t.method = "throw", t.arg = new TypeError("The iterator does not provide a '" + s + "' method")), g;
        var n = j(o, r.iterator, t.arg);
        if ("throw" === n.type) return t.method = "throw", t.arg = n.arg, t.delegate = null, g;
        var u = n.arg;
        return u ? u.done ? (t[r.resultName] = u.value, t.next = r.nextLoc, "return" !== t.method && (t.method = "next", t.arg = e), t.delegate = null, g) : u : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, g);
      }
      function B(e) {
        var r = {
          tryLoc: e[0]
      ...
      function G(r) {
        if (r || "" === r) {
          ...
          if (!isNaN(r.length)) {
            var o = -1,
              u = function t() {
                for (; ++o < r.length;) if (n.call(r, o)) return t.value = r[o], t.done = !1, t;
      ...
      return v.prototype = b, u(L, "constructor", {
        value: b,
        configurable: !0
      }), u(b, "constructor", {
        value: v,
        configurable: !0
      }), v.displayName = d(b, l, "GeneratorFunction"), r.isGeneratorFunction = function (e) {
        var r = "function" == typeof e && e.constructor;
        return !!r && (r === v || "GeneratorFunction" === (r.displayName || r.name));
      }, r.mark = function (e) {
        return Object.setPrototypeOf ? Object.setPrototypeOf(e, b) : (e.__proto__ = b, d(e, l, "GeneratorFunction")), e.prototype = Object.create(L), e;
      }, r.awrap = function (e) {
        return {
          __await: e
        };
      }, k(S.prototype), d(S.prototype, a, function () {
        return this;
      }), r.AsyncIterator = S, r.async = function (e, t, s, o, n) {
        void 0 === n && (n = Promise);
        var u = new S(m(e, t, s, o), n);
        return r.isGeneratorFunction(t) ? u : u.next().then(function (e) {
          return e.done ? e.value : u.next();
        });
      }, k(L), d(L, l, "Generator"), d(L, c, function () {
        return this;
      ...
      }, r.values = G, P.prototype = {
        constructor: P,
        reset: function (r) {
          if (this.prev = 0, this.next = 0, this.sent = this._sent = e, this.done = !1, this.delegate = null, this.method = "next", this.arg = e, this.tryEntries.forEach(O), !r) for (var t in this) "t" === t.charAt(0) && n.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = e);
        },
        stop: function () {
          this.done = !0;
        ...
        abrupt: function (e, r) {
          ...
          return u.type = e, u.arg = r, o ? (this.method = "next", this.next = o.finallyLoc, g) : this.complete(u);
        },
    ...
    i && i.addEventListener("submit", function (r) {
      r.preventDefault();
      var t = document.getElementById("email").value,
        s = document.getElementById("password").value;
      (0, e.login)(t, s);
    }), c && c.addEventListener("submit", function (r) {
      r.preventDefault();
      ...
      (0, e.signup)(t, s, o, n);
    }), a && a.addEventListener("click", e.logout), l && l.addEventListener("submit", function (e) {
      e.preventDefault();
      var t = new FormData();
      t.append("name", document.getElementById("name").value), t.append("email", document.getElementById("email").value), t.append("photo", document.getElementById("photo").files[0]), (0, r.updateSettings)(t, "data");
    }), d && d.addEventListener("submit", function () {
      var e = u(o().mark(function e(t) {
        var s, n, u;
        return o().wrap(function (e) {
          for (;;) switch (e.prev = e.next) {
            case 0:
              return t.preventDefault(), document.querySelector(".btn--save-password").textContent = "Updating...", s = document.getElementById("password-current").value, n = document.getElementById("password").value, u = document.getElementById("password-confirm").value, e.next = 7, (0, r.updateSettings)({
                passwordCurrent: s,
                password: n,
                passwordConfirm: u
              }, "password");
            case 7:
              document.querySelector(".btn--save-password").textContent = "Save Password", document.getElementById("password-current").value = "", document.getElementById("password").value = "", document.getElementById("password-confirm").value = "";
            case 11:
            case "end":
              return e.stop();
          }
